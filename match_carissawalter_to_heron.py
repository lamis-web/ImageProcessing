...
CARISSA_WALTER_DATASHEET_PATH = './Data/CarissaWalter/COVID_CTs_20210513CarissaWalter_0608jc_20210630.xlsx'
...
merged_df = pd.merge(carissa_df, heron_df, how="inner", on=[
                     'mrn'])
